...
public class Setting {
    ...
    // path
    protected static final String MENU_SCENE_PATH = "/Scene/Menu.fxml";
    protected static final String LEVEL_1_SCENE_PATH = "/Scene/Level_1.fxml";
    
    // images
    public static final String MENU_IMAGE_PATH = "/Images/Doggy_gods_street.png";
    public static final String KORONE_IMAGE_PATH = "/Images/Korone.png";
}
